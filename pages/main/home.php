...
<div>
    ...
    <div id="slides" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="intro-slide" src="./assets/image/banner/bn1.jpg" alt="banner">              
            </div>
            <div class="carousel-item">
              <img class="intro-slide" src="./assets/image/banner/bn2.jpg" alt="banner">
            </div>
            <div class="carousel-item">
              <img class="intro-slide" src="./assets/image/banner/bn3.jpg" alt="banner">
            </div>
          </div>
        </div>
    ...
    <div class="container text-center">
        <h2 class="text-dark">Nguốn hàng của ABC Shop</h2>
        <p class="text-dark">
            <i
                >Phụ kiện công nghệ - Nâng cao trải nghiệm của bạn.</i
            >
        </p>
    </div>
